...
class StockBarraMomentum(Factor):
    def __init__(self):
        rq.init()
    
    def factor_name(self) -> str:
        return "StockBarraMomentum"
    
    def author(self) -> str:
        return "xitong"
    
    def desc(self)->str:
        return "stock barra momentum factor"
...
if __name__ == '__main__':
    ...
    print(df, err)
    df.to_pickle("StockBarraMomentum.pkl")
