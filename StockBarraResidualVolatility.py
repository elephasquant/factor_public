...
class StockBarraResidualVolatility(Factor):
    def __init__(self):
        rq.init()
    
    def factor_name(self) -> str:
        return "StockBarraResidualVolatility"
    
    def author(self) -> str:
        return "xitong"
    
    def desc(self)->str:
        return "stock barra residual volatility factor"
...
if __name__ == '__main__':
    now = datetime.now()
    factor = StockBarraResidualVolatility()
    try:
    ...
    print(df, err)
    df.to_pickle("StockBarraResidualVolatility.pkl")
