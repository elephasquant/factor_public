...
class StockBarraEarningsYield(Factor):
    def __init__(self):
        pass
    
    def factor_name(self) -> str:
        return "StockBarraEarningsYield"
    
    def author(self) -> str:
        return "xitong"
    
    def desc(self)->str:
        return "stock barra earnings yield factor"
...
if __name__ == '__main__':
    now = datetime.now()
    factor = StockBarraEarningsYield()
    try:
    ...
    print(df, err)
    df.to_pickle("StockBarraEarningsYield.pkl")
